<template>
            ...
            <div slot="search">
                ...
                <g-table-search>
                    <g-form v-ref:dictionary_searchform slot="search-content">
                        ...
                        <div class="ilb pd5">
                            <g-input name="storeDescription" :label="i18n.storeDescription"></g-input>
                        </div>
    ...
    <g-dialog v-ref:dictionary_dialog_add size="3">
        <span slot="title" v-text="i18n.createStore"></span>
        <div class="clear" slot="content">
            <g-form v-ref:dictionary_addform>
                <g-input-noempty name='code' :label="i18n.code" parentclass="col-xs-6"></g-input-noempty>
                <g-input-noempty name='name' :label="i18n.name" parentclass="col-xs-6"></g-input-noempty>
                <div class="col-xs-6 box">
                    <g-select name="parentID" :_list="select_buparentid" :label="i18n.parentID"></g-select>
                </div>
                <div class="col-xs-6 box">
                    <span v-text="i18n.status"></span>
                    <g-radio-list  name="status" :list="select_statustype"></g-radio-list>
                ...
                <br>
                <div class="col-xs-12 box" v-text="i18n.adminUserInfo"></div>
                <g-input-noempty name='createUserAccount' :label="i18n.createUserAccount" parentclass="col-xs-6"></g-input-noempty>
                <g-input-noempty name='createUserName' :label="i18n.createUserName" parentclass="col-xs-6"></g-input-noempty>
                <g-input-noempty name='employeeCode' :label="i18n.employeeCode" parentclass="col-xs-6"></g-input-noempty>
                <g-input-email name='emailAddress' :label="i18n.emailAddress" parentclass="col-xs-6"></g-input-email>
                <div  class="col-xs-6">
                    <g-select name="country" :_list="select_country" :label="i18n.contactPhone" parentclass="col-xs-6"></g-select>
                </div>
                <g-input-noempty name='phoneNum' parentclass="col-xs-6"></g-input-noempty>
            </g-form>
        </div>
...
<script>
    ...
    import selfOperatedBiz from '../../biz/oms/organizationalStructure/selfOperatedBiz'
    ...
    export default{
        components: {
            ...
            gInputEmail: require('../../../components/input/input-email.vue'),
        ...
        methods: {
            ...
            e_editSubmit() {
                ...
                if (check.ischeck) {
                    selfOperatedBiz.editSelfOperated(check.data).then(function (d) {
            ...
            e_openDel() {
                ...
                util.wait(function () {
                    ...
                    util.dialogTipsShow({
                        ...
                        callBack: function () {
                            selfOperatedBiz.delSelfOperated({
                                id: id
                            }).then(function () {
                                //删除成功以后显示提示信息
                                util.middleTipsShow({
            ...
            e_addSubmit() {
                ...
                var check = form.getData();
                if (check.ischeck) {
                    selfOperatedBiz.addSelfOperated(check.data).then(function (d) {
...
//                        test:true,
        ...
        ready() {
            ...
            function selectMvnoCode() {
                ...
                selfOperatedBiz.searchSelfOperated(data).then(function (d) {
                    var mvnoCode = {};
                    $.each(d.data.dataList, function (k, v) {
//                        console.log(v);
//                        console.log(v.mvnoCode);
                        mvnoCode[v.id] = v.mvnoCode;
                        that.select_mvnoCode = mvnoCode;
                    })
                })
            }
            lan.getLan('v_selfOperated').then(function (lanObj) {
                that.i18n = lanObj;
                that.select_statustype = lanObj.status_type;
                that.select_pusWaytype = lanObj.pushWay_tpye;
                that.select_buparentid = lanObj.bu_parentID;
                that.select_country = lanObj.country;
                selectMvnoCode();
            });
            window.$$routeList.selfOperatedBiz = this;
        }
    }
</script>